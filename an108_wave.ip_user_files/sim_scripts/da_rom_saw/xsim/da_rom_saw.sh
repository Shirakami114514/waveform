...
#
# Generated by Vivado on Fri Jan 28 15:36:32 +0800 2022
# SW Build 2700185 on Thu Oct 24 18:46:05 MDT 2019
#
# Copyright 1986-2019 Xilinx, Inc. All Rights Reserved. 
#
# usage: da_rom_saw.sh [-help]
# usage: da_rom_saw.sh [-lib_map_path]
# usage: da_rom_saw.sh [-noclean_files]
# usage: da_rom_saw.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "da_rom_saw.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot da_rom_saw xil_defaultlib.da_rom_saw xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim da_rom_saw -key {Behavioral:sim_1:Functional:da_rom_saw} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./da_rom_saw.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb da_rom_saw.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./da_rom_saw.sh -help\" for more information)\n"
    exit 1
  fi
