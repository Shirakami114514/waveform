...
#
# Generated by export_simulation on Fri Jan 28 15:36:32 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './da_rom_saw.sh' script.

./da_rom_saw.sh -reset_run
...
./da_rom_saw.sh -noclean_files

For more information on the script, please type './da_rom_saw.sh -help'.
