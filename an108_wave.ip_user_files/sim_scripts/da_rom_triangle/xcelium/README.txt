...
#
# Generated by export_simulation on Fri Jan 28 15:28:55 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './da_rom_triangle.sh' script.

./da_rom_triangle.sh -reset_run
...
./da_rom_triangle.sh -noclean_files

For more information on the script, please type './da_rom_triangle.sh -help'.
