...
HD_PWD='E:/waveform/an108_wave.runs/da_rom_square_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log da_rom_square.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source da_rom_square.tcl
